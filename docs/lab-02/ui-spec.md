...
*   **Text Truncation:** ข้อมูลที่ยาวเกินไปในตาราง และชื่อไฟล์แนบ ให้ตัดคำด้วยเครื่องหมาย `...` (`text-overflow: ellipsis`) และแสดง Tooltip เมื่อชี้เมาส์
...
- [ ] Accessibility (WCAG AA): ตรวจสอบความต่างของสี (Contrast) ของข้อความและพื้นหลังให้อ่านง่าย
- [ ] State Feedback: แสดง Loading spinner เมื่อกดปุ่ม Submit
- [ ] Responsive Design: ตาราง (Table) เปลี่ยนรูปแบบเป็นการ์ด (Card layout) เมื่อเปิดบนหน้าจอมือถือ (< 768 px)
- [ ] Screen Reader Support: ปุ่มที่เป็นไอคอนต้องมีการใส่ `aria-label` กำกับไว้เสมอ