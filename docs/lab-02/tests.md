...
| API-05 | File Upload | อัปโหลดไฟล์ไม่ใช่ภาพ/PDF (ตรวจจับจาก MIME Type จริงๆ ไม่ใช่นามสกุลไฟล์) | 400 Bad Request | Pending |
| API-06 | File Upload | อัปโหลดไฟล์ใหญ่เกิน 5MB | 400 Bad Request | Pending |
...
| API-13 | Ticket | ตรวจสอบการคืนค่ากรณีค้นหาไม่พบข้อมูล | 200 OK และส่งกลับ Array ว่าง [] | Pending |
...
| UI-04 | Responsive | E2E Test ตรวจสอบการแสดงผลบนจอมือถือ | ตารางรายการตั๋ว (Table) เปลี่ยนรูปแบบเป็นการ์ด (Card layout) อย่างถูกต้อง | Pending |
...
| UI-07 | Pagination | E2E Test ทดสอบระบบแบ่งหน้า (Pagination) บน Desktop | สามารถเปลี่ยนหน้า, คลิก Next/Prev และแสดงข้อมูลได้ถูกต้อง | Pending |
| UI-08 | UI | ดักจับข้อความแจ้งเตือนเมื่อไม่มีข้อมูล ("ไม่พบข้อมูล" หรือ "No tickets found") ในหน้าตาราง | แสดงข้อความแจ้งเตือนชัดเจน | Pending |
